...
The **Web Content Accessibility Guidelines (WCAG pronounced "We-kag")**

- The principles are: **(POUR)**:
  - **"Perceivable"** -> Users can see, hear, or otherwise perceive the content
    - Text alternatives for non-text content
  - **"Operable"** -> Users can navigate and interact without blockers
    - Keyboard accessibility, focus management, and navigation consistency
...
- They define three levels of compliance:
