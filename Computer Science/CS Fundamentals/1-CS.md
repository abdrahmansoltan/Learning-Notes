...
- **Software Engineering:** Focuses on project management, testing, iterating, profiling, and shipping software.
- **Computer Science:** Focuses on the theory of computation, data structures, Big-O notation, algorithms, and the underlying mathematics.
- **The Takeaway:** You can be a highly effective Software Engineer without a formal CS degree because computers are just machines built on simple, understandable standards, not magic [2, 3]. The missing CS fundamentals are just chunks of knowledge with names you haven't learned yet.
